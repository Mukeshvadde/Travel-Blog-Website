...
<body style="background:url('giphyt.gif');background-size:cover;background-repeat:no-repeat;background-attachment:fixed;margin-left:0px">
    <div class="details mt-3">
        <fieldset style="background:url('moving.gif');background-attachment:fixed;background-repeat:no-repeat;background-size:cover;">
        <h1>Sign Up</h1>
        ...
        <form method="POST" action="login.php">
            ...
            <p><b>Already have account?<a href="login.php" style="color:black">Login Here</a></b></p>
        </form>
        </fieldset>
    </div>
</body>
